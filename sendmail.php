...
if (isset($_POST['btnSend'])) {
    ...
    if ((!empty($nome)) && (!empty($email)) && (!empty($telefone)) && (!empty($assunto)) && (!empty($mensagem))) {
        ...
        $email_remetente = "contato@alfanerd.com.br"; // deve ser uma conta de email do seu dominio 
        $email_destinatario = $email; // email que receberá as mensagens
        $email_recebidoDe = "$email";
        $email_assunto = "Envio Teste do Formulário de Contato | Alfa Nerd"; // Este será o assunto da mensagem
